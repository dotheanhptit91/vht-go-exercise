...
// func (e DefaultError) WithErrDetails(errs []validation.ErrDetailData) *DefaultError {
// 	if e.DetailsField == nil {
// 		e.DetailsField = map[string]interface{}{}
// 	}

// 	for _, err := range errs {
// 		e.DetailsField[err.GetField()] = err
// 	}
...
var ErrDeleted = DefaultError{
	StatusField: http.StatusText(http.StatusBadRequest),
	ErrorField:  "The requested resource has been deleted",
	CodeField:   http.StatusNotFound,
}
